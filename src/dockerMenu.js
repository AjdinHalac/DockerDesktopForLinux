...
const { KubectlSubMenu } = Me.imports.src.kubectlSubMenuMenuItem;
...
var DockerMenu = GObject.registerClass(
  class DockerMenu extends panelMenu.Button {
    ...
    _feedMenu() {
      ...
      if (Kubectl.isKubectlInstalled()) {
        this.menu.addMenuItem(new PopupMenu.PopupSeparatorMenuItem());
        this.menu.addMenuItem(new KubectlSubMenu(Kubectl.getCurrentContext(), Kubectl.getContexts()));
      }
    }
  }
);